...
I have most recently worked as a **data protection engineer** focused on encryption and masking: enterprise key management and HSMs, PKI and digital certificate lifecycle management, tokenization, database and file-level encryption, and the CI/CD, IaC, and PaC best practices that keep all of it running at scale.
